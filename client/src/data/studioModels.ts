...
export const STUDIO_MODELS: StudioModel[] = [
  {
    ...
    description: 'High-detail architectural villa model with clean geometry. Optimized for renders and real-time viz.',
    price: 89,
    format: 'RVT',
  ...
  {
    id: 'sm-3',
    name: 'Brutalist Concrete Block',
    description: 'Modular concrete block system for Revit. Parametric family with LOD levels.',
    price: 120,
    format: 'RVT',
    category: 'Architectural',
  ...
  {
    id: 'sm-6',
    name: 'Residential Floor Plan Kit',
    description: '2D/3D floor plan elements and furniture in DWG. Scale-accurate for documentation.',
    price: 65,
    format: 'DWG',
    category: 'Architectural',
